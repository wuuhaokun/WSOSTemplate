...
//        -> RequestTaskManager
//    {
//        let taskManager : RequestTaskManager? = RequestTaskManager()
//        taskManager!.dataRequest = Alamofire.request(url, method: method, parameters: params).responseJSON(options: .allowFragments)
//        return taskManager!
//    }
}
