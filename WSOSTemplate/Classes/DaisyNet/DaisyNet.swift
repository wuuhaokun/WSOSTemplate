...
///   - params: 参数
///   - dynamicParams: 变化的参数，例如 时间戳-token 等
static public func cancel(_ url: String, params: Parameters? = nil, dynamicParams: Parameters? = nil) {
...
static public func removeAllCache(completion: @escaping (Bool)->()) {
...
///   - dynamicParams: 变化的参数，例如 时间戳-token 等
///   - completion: 完成回调
static public func removeObjectCache(_ url: String, params: [String: Any]? = nil, dynamicParams: Parameters? = nil, completion: @escaping (Bool)->()) {
...
///
/// - Parameter url: url
static public func downloadCancel(_ url: String, parameters: Parameters? = nil, dynamicParams: Parameters? = nil) {
    DownloadManager.default.cancel(url, parameters: parameters, dynamicParams: dynamicParams)
}

/// Cancel all download tasks
static public func downloadCancelAll() {
...
/// - Parameter url: url
/// - Returns: percent
static public func downloadPercent(_ url: String, parameters: Parameters? = nil, dynamicParams: Parameters? = nil) -> Double {
...
static public func downloadDelete(_ url: String, parameters: Parameters? = nil,dynamicParams: Parameters? = nil, completion: @escaping (Bool)->()) {
...
/// - Parameter url: url
/// - Returns: status
static public func downloadStatus(_ url: String, parameters: Parameters? = nil,dynamicParams: Parameters? = nil) -> DownloadStatus {
...
/// - Parameter url: url
/// - Returns: file URL
static public func downloadFilePath(_ url: String, parameters: Parameters? = nil,dynamicParams: Parameters? = nil) -> URL? {
...
/// - Returns: taskManager
@discardableResult
static public func downloadProgress(_ url: String, parameters: Parameters? = nil,dynamicParams: Parameters? = nil, progress: @escaping ((Double)->())) -> DownloadTaskManager? {
...
extension DaisyNet {
    //同步網路抓取資料
//    public static func synchronousRequest(_ url: String, method: HTTPMethod = .get, parameters: Parameters? = nil) -> RequestTaskManager {
//        return RequestManager.default.synchronousRequest(url, method: method, params: parameters)
//    }
}
