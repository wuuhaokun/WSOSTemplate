...
extension UITableView {
    ...
    private var systemAccessoryWidths: [UITableViewCell.AccessoryType: CGFloat] {
        return [
            .none: 0,
    ...
    public func fd_heightForHeaderFooterView(with identifier: String, configuration _: ((UIView) -> Void)?) -> CGFloat {
        ...
        var fittingHeight = templateHeaderFooterView.systemLayoutSizeFitting(UIView.layoutFittingCompressedSize).height
